...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ __('ban-ip::base.view.title') }}</title>
    </head>
    <body>
    <link href="https://fonts.googleapis.com/css?family=Do+Hyeon|Frijole|Josefin+Sans:300,400,400i,600,700|Viga" rel="stylesheet">
    <style>
        html {height: 100%;}
        body{background-color: #f4f3f5;min-height: 100%;background-image: url("data:image/svg+xml,%3Csvg width='42' height='44' viewBox='0 0 42 44' xmlns='http://www.w3.org/2000/svg'%3E%3Cg id='Page-1' fill='none' fill-rule='evenodd'%3E%3Cg id='brick-wall' fill='%236ba184' fill-opacity='0.21'%3E%3Cpath d='M0 0h42v44H0V0zm1 1h40v20H1V1zM0 23h20v20H0V23zm22 0h20v20H22V23z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");}
        svg{transform: scale(0.3,0.3);margin-top:-45%;}
        .st0{display:none;}
...
@if($timer)
    <script>
        ...
        let interval = setInterval(function() {
            time--;
            timer.textContent = displayTime(time);
            if (time <= 0) {
